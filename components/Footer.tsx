...
export default function Footer() {
  return(
    <footer className="flex flex-col gap-12">
      <p className="text-md sm:text-xl"><span className="opacity-50">I am looking forward on your next project. </span><Link href="mailto:ricosnjys@gmail.com" className="underline underline-offset-2 opacity-50 hover:opacity-100">ricosnjys@gmail.com</Link></p>
