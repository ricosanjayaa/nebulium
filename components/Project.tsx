...
export default function Project({ title, description, badges, id }: { title: string, description: string, badges: string[], id: string }) {
  return (
    ...
    <Link href="/" className="py-4 cursor-pointer hover:!opacity-100 group-hover:opacity-50 flex flex-col gap-1 group">
      <div className="flex flex-col">
        <p className="text-lg font-medium group-hover:underline underline-offset-2">{title}</p>
